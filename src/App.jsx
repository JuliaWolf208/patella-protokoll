      ...
      <div style={{textAlign:"center",padding:"16px 16px 0"}}>
        ...
        <div style={{marginBottom:8}}>
          <input
            ...
            style={{padding:"6px 12px",borderRadius:8,border:"1px solid rgba(91,163,217,0.3)",background:"rgba(255,255,255,0.06)",color:"#c8dff0",fontSize:14,outline:"none",fontFamily:"Georgia,serif",colorScheme:"dark"}}
          />
        </div>
